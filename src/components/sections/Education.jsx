        ...
        <div className="relative">
          ...
          {education.map((edu, idx) => (
            <Reveal
              ...
              amount={0.2}
            >
              <div className="absolute left-0 top-5 flex h-8 w-8 items-center justify-center rounded-full border border-default bg-surface text-accent-secondary md:left-1/2 md:-translate-x-1/2">
